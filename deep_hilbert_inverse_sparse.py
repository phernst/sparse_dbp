...
class MyDataset(torch.utils.data.Dataset):
    ...
    def _load_ds_if_none(self):
        ...
        return hilbert_volume, image_volume
    ...
    def __getitem__(self, idx):
        self.hilbert_volume, self.image_volume = self._load_ds_if_none()
...
class DeepHilbertInverse(LightningModule):
    ...
    def training_step(self, batch, _):
        hilbert, image = batch['hil'], batch['img']
...
def main():
    ...
    hparams.valid_dir = 'valid_hilbert_inverse_sparse' \
