...
from deep_hilbert_inverse_sparse import DeepHilbertInverse, MyDataset
...
def dataset_prediction(plane: HilbertPlane):
    ...
    pre_dir = 'valid_hilbert_inverse_sparse'
    pre_path = [
    ...
    for idx, sample in enumerate(dataset):
        ...
        pred = model(sample['hil'].unsqueeze(0).cuda())
    ...
    nib.save(image, pjoin('testing', f'inv_sp_{plane.name.lower()}.nii.gz'))
